...
from benchmarks.problems import RastriginProblem
...
def main() -> None:
    progress_panel = create_progress_panel(title="Rastrigin progress") if SHOW_PROGRESS_PANEL else None
    config = {
    ...
    print_benchmark_configuration("Rastrigin", problem=RastriginProblem, config=config)
